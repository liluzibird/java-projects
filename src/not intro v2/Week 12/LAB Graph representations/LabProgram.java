...
public class LabProgram {
	public static void main(String[] args) {
		...
		System.out.print("\n");
		System.out.print("  AdjacencyListGraph:   ");
		System.out.print((adjPass ? "PASS" : "FAIL"));
		System.out.print("\n");
		System.out.print("  AdjacencyMatrixGraph: ");
		System.out.print((matPass ? "PASS" : "FAIL"));
		System.out.print("\n");
	...
	public static boolean testGraph(PrintWriter testFeedback, DirectedGraph graph) {
		ArrayList<DirectedGraphTestCommand> commands = new ArrayList<DirectedGraphTestCommand>() {
			{
