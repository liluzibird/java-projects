...
/*8
The AWTTempConverter class is an applet that converts Fahrenheit temperatures to Celsius.
*/
...
public class AWTTempConverter extends Applet
{
    ...
    private void buildCpanel()
    {
        ...
        // Create a alabel to display a message
    ...
    private class ButtonListener implements ActionListener
    {
        public void actionPerformed(ActionEvent e)
        {
            ...
            // Display teh Celsius temperature.
